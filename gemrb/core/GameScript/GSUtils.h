...
bool ResolveSpellName(ResRef& spellRes, const Holder<Action> parameter);
...
void AmbientActivateCore(const Scriptable* Sender, const Holder<Action> parameters, bool flag);
...
void AddXPCore(const Holder<Action> parameters, bool divide = false);
