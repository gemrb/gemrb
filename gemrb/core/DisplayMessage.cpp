...
{
	DisplayConstantStringNameString(stridx, gamedata->GetColor(GUIColors[color]), stridx2, actor);
}
...
{
	DisplayConstantStringNameValue(stridx, gamedata->GetColor(GUIColors[color]), speaker, value);
}
