...
// by default, hours are offset by half an hour, ie. bit 0 covers the
// time from 0030 to 0129, bit 1 from 0130 to 0229 etc.
bool Schedule(ieDword schedule, ieDword time, int offset)
{
	ieDword hour = 1 << (((time/AI_UPDATE_TIME)+offset)%7200/300);
