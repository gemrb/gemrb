...
#define STR_DOOR_NOPICK     80
#define STR_CONT_NOPICK     81
#define STR_DOOR_CANTPICK   82
#define STR_CONT_CANTPICK   83
#define STR_LOCKPICK_DONE   84

#define STRREF_COUNT 85
