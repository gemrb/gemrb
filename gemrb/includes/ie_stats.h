...
#define STATE_CANTMOVE (STATE_SLEEP|STATE_BERSERK|STATE_PANIC|STATE_STUNNED|STATE_HELPLESS|_DEAD_STATES|STATE_DEACTIVATED|STATE_FEEBLE) // 0x180fef
...
#define STATE_CANTLISTEN (STATE_CANTSEE|STATE_CONFUSED|STATE_HELPLESS|STATE_SLEEP|STATE_BERSERK|STATE_PANIC|STATE_STUNNED) // 0x80080fef
