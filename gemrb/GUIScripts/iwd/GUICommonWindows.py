...
#
# $Header: /data/gemrb/cvs2svn/gemrb/gemrb/gemrb/GUIScripts/iwd/GUICommonWindows.py,v 1.14 2005/12/21 22:58:24 avenger_teambg Exp $
...
def GroupControls ():
	...
	for i in range (5):
		...
		GemRB.SetButtonSprites (Window, Button, "GUIBTBUT",0,i*2,i*2+1,i*2+24,i*2+25)
