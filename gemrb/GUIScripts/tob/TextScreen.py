...
#
# $Header: /data/gemrb/cvs2svn/gemrb/gemrb/gemrb/GUIScripts/tob/TextScreen.py,v 1.1 2005/03/20 21:28:27 avenger_teambg Exp $
...
def StartTextScreen ():
	...
	#replay
	Button=GemRB.GetControl (TextScreen, 1)
	GemRB.SetText (TextScreen, Button, 0)
