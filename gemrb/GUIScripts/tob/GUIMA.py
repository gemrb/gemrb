...
#
# $Header: /data/gemrb/cvs2svn/gemrb/gemrb/gemrb/GUIScripts/tob/GUIMA.py,v 1.9 2004/10/10 13:32:55 avenger_teambg Exp $
...
def OpenMapWindow ():
	...
	# Map Control
	GemRB.CreateMapControl (Window, 2, 0, 0, 0, 0, "FLAG1", Label)
