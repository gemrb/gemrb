...
IE_GUI_MAP_ON_RIGHT_PRESS   = 0x09000001
IE_GUI_MAP_ON_DOUBLE_PRESS  = 0x09000002
...
TARGET_MODE_PICK    = 5
TARGET_TYPE_ALLY    = 0x100
TARGET_TYPE_ENEMY   = 0x200
TARGET_TYPE_NEUTRAL = 0x400
TARGET_TYPE_ALL     = TARGET_TYPE_ALLY | TARGET_TYPE_ENEMY | TARGET_TYPE_NEUTRAL
