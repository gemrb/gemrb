...
def RefreshInventoryWindow ():
	...
	for i in range (6):
		...
		if Slot != None:
			...
			Button.SetEvent (IE_GUI_BUTTON_ON_RIGHT_PRESS, None) #TODO: OpenItemInfoGroundWindow
			Button.SetEvent (IE_GUI_BUTTON_ON_SHIFT_PRESS, None) #TODO: OpenItemAmountGroundWindow
		else:
