...
def IsFeatUsable(feat):
	...
	a_value = GemRB.GetTableValue(FeatReqTable, feat, "A_OP")
	b_value = GemRB.GetTableValue(FeatReqTable, feat, "B_OP")
	c_value = GemRB.GetTableValue(FeatReqTable, feat, "C_OP")
	d_value = GemRB.GetTableValue(FeatReqTable, feat, "D_OP")
