...
def RefreshPDoll():
	...
	GemRB.SetButtonBAM(ColorWindow, PDollButton, ResRef, 0,0, Color1)
	return
...
def OnLoad():
	...
	GemRB.SetButtonBAM(ColorWindow, HairButton, "COLGRAD", 0, 0, Color1)
	...
	GemRB.SetButtonBAM(ColorWindow, SkinButton, "COLGRAD", 0, 0, Color2)
	...
	GemRB.SetButtonBAM(ColorWindow, MajorButton, "COLGRAD", 0, 0, Color3)
	...
	GemRB.SetButtonBAM(ColorWindow, MinorButton, "COLGRAD", 0, 0, Color4)
