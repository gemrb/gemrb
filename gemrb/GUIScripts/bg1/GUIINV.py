...
#
# $Header: /data/gemrb/cvs2svn/gemrb/gemrb/gemrb/GUIScripts/bg1/GUIINV.py,v 1.20 2006/08/06 17:18:48 avenger_teambg Exp $
...
def RefreshInventoryWindow ():
	...
	GemRB.SetButtonPLT (Window, Button, GetActorPaperDoll (pc),
		Color5, Color4, Color3, Color2, Color6, Color7, Color1, 0, 0)
