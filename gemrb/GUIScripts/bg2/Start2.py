...
#tutorial subwindow
	...
	CancelButton.SetEventByName (IE_GUI_BUTTON_ON_PRESS, "CancelTut")
...
#main window
	...
	BackButton.SetEventByName (IE_GUI_BUTTON_ON_PRESS, "Restart")
...
def SinglePlayerPress():
	...
	MoviesButton.SetEventByName (0, "Tutorial")
