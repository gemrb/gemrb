...
#
# $Header: /data/gemrb/cvs2svn/gemrb/gemrb/gemrb/GUIScripts/bg2/LoadScreen.py,v 1.3 2004/08/10 19:54:42 avenger_teambg Exp $
...
def StartLoadScreen ():
	...
	if LoadPic == "":
		LoadPic = "GTRSK00"+str(GemRB.Roll(1,6,0) )
