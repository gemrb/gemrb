...
def OnLoad():
	...
	SubtitleButton.SetEventByName(IE_GUI_BUTTON_ON_PRESS, "SubtitlePress")
	SubtitleButtonB.SetEventByName(IE_GUI_BUTTON_ON_PRESS, "SubtitlePress")
	SubtitleButtonB.SetFlags(IE_GUI_BUTTON_CHECKBOX,OP_OR)
	SubtitleButtonB.SetVarAssoc("Subtitles",1)

	WarCryButton.SetEventByName(IE_GUI_BUTTON_ON_PRESS, "WarCryPress")
	WarCryButtonB.SetEventByName(IE_GUI_BUTTON_ON_PRESS, "WarCryPress")
	WarCryButtonB.SetFlags(IE_GUI_BUTTON_CHECKBOX,OP_OR)
	WarCryButtonB.SetVarAssoc("Attack Sounds",1)

	StepsButton.SetEventByName(IE_GUI_BUTTON_ON_PRESS, "StepsPress")
	StepsButtonB.SetEventByName(IE_GUI_BUTTON_ON_PRESS, "StepsPress")
	StepsButtonB.SetFlags(IE_GUI_BUTTON_CHECKBOX,OP_OR)
	StepsButtonB.SetVarAssoc("Footsteps",1)

	ActionButton.SetEventByName(IE_GUI_BUTTON_ON_PRESS, "ActionPress")
	ActionButtonB1.SetEventByName(IE_GUI_BUTTON_ON_PRESS, "ActionPress")
	ActionButtonB1.SetFlags(IE_GUI_BUTTON_RADIOBUTTON,OP_OR)
	ActionButtonB1.SetVarAssoc("Command Sounds Frequency",1)

	ActionButtonB2.SetEventByName(IE_GUI_BUTTON_ON_PRESS, "ActionPress")
	ActionButtonB2.SetFlags(IE_GUI_BUTTON_RADIOBUTTON,OP_OR)
	ActionButtonB2.SetVarAssoc("Command Sounds Frequency",2)

	ActionButtonB3.SetEventByName(IE_GUI_BUTTON_ON_PRESS, "ActionPress")
	ActionButtonB3.SetFlags(IE_GUI_BUTTON_RADIOBUTTON,OP_OR)
	ActionButtonB3.SetVarAssoc("Command Sounds Frequency",3)

	SelectionButton.SetEventByName(IE_GUI_BUTTON_ON_PRESS, "SelectionPress")
	SelectionButtonB1.SetEventByName(IE_GUI_BUTTON_ON_PRESS, "SelectionPress")
	SelectionButtonB1.SetFlags(IE_GUI_BUTTON_RADIOBUTTON,OP_OR)
	SelectionButtonB1.SetVarAssoc("Selection Sounds Frequency",1)

	SelectionButtonB2.SetEventByName(IE_GUI_BUTTON_ON_PRESS, "SelectionPress")
	SelectionButtonB2.SetFlags(IE_GUI_BUTTON_RADIOBUTTON,OP_OR)
	SelectionButtonB2.SetVarAssoc("Selection Sounds Frequency",2)

	SelectionButtonB3.SetEventByName(IE_GUI_BUTTON_ON_PRESS, "SelectionPress")
