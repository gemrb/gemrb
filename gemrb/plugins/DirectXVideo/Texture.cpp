 ...
 *
 * $Header: /data/gemrb/cvs2svn/gemrb/gemrb/gemrb/plugins/DirectXVideo/Texture.cpp,v 1.4 2004/02/24 22:20:38 balrog994 Exp $
 *
 */
...
void Texture::Init(void* pixels, int w, int h, int bpp, void* palette,
	bool cK, int index)
{
	HRESULT ddrval;
	...
	ddrval = lpD3DDevice->CreateTexture( w, h, 1, 0, D3DFMT_A8R8G8B8,
