...
// SPDX-FileCopyrightText: Copyright (c) 2007-2009 Peter Ross (pross@xvid.org)
// SPDX-FileCopyrightText: Copyright (c) 2009 Daniel Verkamp (daniel@drv.nu)
// SPDX-FileCopyrightText: Copyright (c) 2009 Konstantin Shishkov
...
int BIKPlayer::read_dct_coeffs(DCTELEM block[64], const uint8_t* scan, bool is_intra)
{
	...
	quant = is_intra ? bink_intra_quant[quant_idx] : bink_inter_quant[quant_idx];
