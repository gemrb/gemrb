// SPDX-FileCopyrightText: 2003-2007 Contributors to the GemRB project <https://gemrb.org>
//
// SPDX-License-Identifier: GPL-2.0-or-later

// TlkOverride: implementation of the saved game specific (dynamic) part of the talk table (TLK)
