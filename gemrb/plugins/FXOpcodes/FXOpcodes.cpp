...
static EffectDesc effectnames[] = {
	EffectDesc("*Crash*", fx_crash, EFFECT_NO_ACTOR, -1, DebugEffectFormater<false>() ),
	EffectDesc("AcidResistanceModifier", fx_acid_resistance_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ACVsCreatureType", fx_generic_effect, 0, -1, DebugEffectFormater<false>() ), //0xdb
	EffectDesc("ACVsDamageTypeModifier", fx_ac_vs_damage_type_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ACVsDamageTypeModifier2", fx_ac_vs_damage_type_modifier, 0, -1, DebugEffectFormater<false>() ), // used in IWD
	EffectDesc("AidNonCumulative", fx_set_aid_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("AIIdentifierModifier", fx_ids_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("AlchemyModifier", fx_alchemy_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Alignment:Change", fx_alignment_change, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Alignment:Invert", fx_alignment_invert, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("AlwaysBackstab", fx_always_backstab_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("AnimationIDModifier", fx_animation_id_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("AnimationStateChange", fx_animation_stance, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ApplyEffect", fx_apply_effect, EFFECT_NO_ACTOR, -1, DebugEffectFormater<false>() ),
	EffectDesc("ApplyEffectCurse", fx_apply_effect_curse, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ApplyEffectItem", fx_apply_effect_item, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ApplyEffectItemType", fx_apply_effect_item_type, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ApplyEffectRepeat", fx_apply_effect_repeat, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("CutScene2", fx_cutscene2, EFFECT_NO_ACTOR, -1, DebugEffectFormater<false>() ),
	EffectDesc("AttackSpeedModifier", fx_attackspeed_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("AttacksPerRoundModifier", fx_attacks_per_round_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("AuraCleansingModifier", fx_auracleansing_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("SummonDisable", fx_summon_disable, 0, -1, DebugEffectFormater<false>() ), //unknown
	EffectDesc("AvatarRemovalModifier", fx_avatar_removal_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("BackstabModifier", fx_backstab_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("BerserkStage1Modifier", fx_berserkstage1_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("BerserkStage2Modifier", fx_berserkstage2_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("BlessNonCumulative", fx_set_bless_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Bounce:School", fx_bounce_school, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Bounce:SchoolDec", fx_bounce_school_dec, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Bounce:SecondaryType", fx_bounce_secondary_type, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Bounce:SecondaryTypeDec", fx_bounce_secondary_type_dec, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Bounce:Spell", fx_bounce_spell, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Bounce:SpellDec", fx_bounce_spell_dec, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Bounce:SpellLevel", fx_bounce_spelllevel, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Bounce:SpellLevelDec", fx_bounce_spelllevel_dec, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Bounce:Opcode", fx_bounce_opcode, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Bounce:Projectile", fx_bounce_projectile, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("CantUseItem", fx_generic_effect, EFFECT_NO_ACTOR, -1, DebugEffectFormater<false>() ),
	EffectDesc("CantUseItemType", fx_generic_effect, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("CanUseAnyItem", fx_can_use_any_item_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("CastFromList", fx_select_spell, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("CastingGlow", fx_casting_glow, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("CastingGlow2", fx_casting_glow, 0, -1, DebugEffectFormater<false>() ), //used in iwd
	EffectDesc("CastingLevelModifier", fx_castinglevel_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("CastingSpeedModifier", fx_castingspeed_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("CastSpellOnCondition", fx_cast_spell_on_condition, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ChangeBardSong", fx_change_bardsong, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ChangeName", fx_change_name, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ChangeWeather", fx_change_weather, EFFECT_NO_ACTOR, -1, DebugEffectFormater<false>() ),
	EffectDesc("ChantBadNonCumulative", fx_set_chantbad_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ChantNonCumulative", fx_set_chant_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ChaosShieldModifier", fx_chaos_shield_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("CharismaModifier", fx_charisma_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("CheckForBerserkModifier", fx_checkforberserk_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ColdResistanceModifier", fx_cold_resistance_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Color:BriefRGB", fx_brief_rgb, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Color:GlowRGB", fx_glow_rgb, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Color:DarkenRGB", fx_darken_rgb, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Color:SetPalette", fx_set_color_gradient, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Color:SetRGB", fx_set_color_rgb, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Color:SetRGBGlobal", fx_set_color_rgb_global, 0, -1, DebugEffectFormater<false>() ), //08
	EffectDesc("Color:PulseRGB", fx_set_color_pulse_rgb, 0, -1, DebugEffectFormater<false>() ), //9
	EffectDesc("Color:PulseRGBGlobal", fx_set_color_pulse_rgb_global, 0, -1, DebugEffectFormater<false>() ), //9
	EffectDesc("ConstitutionModifier", fx_constitution_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ControlCreature", fx_set_charmed_state, 0, -1, DebugEffectFormater<false>() ), //0xf1 same as charm
	EffectDesc("CreateContingency", fx_create_contingency, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("CriticalHitModifier", fx_critical_hit_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("CrushingResistanceModifier", fx_crushing_resistance_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:Berserk", fx_cure_berserk_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:Blind", fx_cure_blind_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:CasterHold", fx_unpause_caster, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:Confusion", fx_cure_confused_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:Deafness", fx_cure_deaf_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:Death", fx_cure_dead_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:Defrost", fx_cure_frozen_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:Disease", fx_cure_diseased_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:Feeblemind", fx_cure_feebleminded_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:Hold", fx_cure_hold_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:Imprisonment", fx_freedom, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:Infravision", fx_cure_infravision_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:Intoxication", fx_cure_intoxication, 0, -1, DebugEffectFormater<false>() ), //0xa4 (iwd2 has this working)
	EffectDesc("Cure:Invisible", fx_cure_invisible_state, 0, -1, DebugEffectFormater<false>() ), //0x2f
	EffectDesc("Cure:Invisible2", fx_cure_invisible_state, 0, -1, DebugEffectFormater<false>() ), //0x74
	//EffectDesc("Cure:ImprovedInvisible", fx_cure_improved_invisible_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:LevelDrain", fx_cure_leveldrain, 0, -1, DebugEffectFormater<false>() ), //restoration
	EffectDesc("Cure:Nondetection", fx_cure_nondetection_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:Panic", fx_cure_panic_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:Petrification", fx_cure_petrified_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:Poison", fx_cure_poisoned_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:Sanctuary", fx_cure_sanctuary_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:Silence", fx_cure_silenced_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:Sleep", fx_cure_sleep_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Cure:Stun", fx_cure_stun_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("CurrentHPModifier", fx_current_hp_modifier, EFFECT_DICED, -1, DebugEffectFormater<false>() ),
	EffectDesc("Damage", fx_damage, EFFECT_DICED, -1, DebugEffectFormater<false>() ),
	EffectDesc("DamageAnimation", fx_damage_animation, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("DamageBonusModifier", fx_damage_bonus_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("DamageLuckModifier", fx_damageluck_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("DamageVsCreature", fx_generic_effect, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Death", fx_death, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Death2", fx_death, 0, -1, DebugEffectFormater<false>() ), //(iwd2 effect)
	EffectDesc("Death3", fx_death, 0, -1, DebugEffectFormater<false>() ), //(iwd2 effect too, Banish)
	EffectDesc("DetectAlignment", fx_detect_alignment, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("DetectIllusionsModifier", fx_detect_illusion_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("DexterityModifier", fx_dexterity_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("DimensionDoor", fx_dimension_door, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("DisableButton", fx_disable_button, 0, -1, DebugEffectFormater<false>() ), //sets disable button flag
	EffectDesc("DisableChunk", fx_disable_chunk_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("DisableOverlay", fx_disable_overlay_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("DisableCasting", fx_disable_spellcasting, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Disintegrate", fx_disintegrate, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("DispelEffects", fx_dispel_effects, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("DispelSchool", fx_dispel_school, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("DispelSchoolOne", fx_dispel_school_one, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("DispelSecondaryType", fx_dispel_secondary_type, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("DispelSecondaryTypeOne", fx_dispel_secondary_type_one, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("DisplayString", fx_display_string, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Dither", fx_dither, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("DontJumpModifier", fx_dontjump_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("DrainItems", fx_drain_items, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("DrainSpells", fx_drain_spells, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("DropWeapon", fx_drop_weapon, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ElectricityResistanceModifier", fx_electricity_resistance_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ExistanceDelayModifier", fx_existance_delay_modifier , 0, -1, DebugEffectFormater<false>() ), //unknown
	EffectDesc("ExperienceModifier", fx_experience_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ExploreModifier", fx_explore_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("FamiliarBond", fx_familiar_constitution_loss, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("FamiliarMarker", fx_familiar_marker, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Farsee", fx_farsee, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("FatigueModifier", fx_fatigue_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("FindFamiliar", fx_find_familiar, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("FindTraps", fx_find_traps, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("FindTrapsModifier", fx_find_traps_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("FireResistanceModifier", fx_fire_resistance_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("FistDamageModifier", fx_fist_damage_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("FistHitModifier", fx_fist_to_hit_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ForceSurgeModifier", fx_force_surge_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ForceVisible", fx_force_visible, 0, -1, DebugEffectFormater<false>() ), //not invisible but improved invisible
	EffectDesc("FreeAction", fx_cure_slow_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("GenerateWish", fx_generate_wish, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("GoldModifier", fx_gold_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("HideInShadowsModifier", fx_hide_in_shadows_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("HLA", fx_generic_effect, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("HolyNonCumulative", fx_set_holy_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Icon:Disable", fx_disable_portrait_icon, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Icon:Display", fx_display_portrait_icon, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Icon:Remove", fx_remove_portrait_icon, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Identify", fx_identify, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("IgnoreDialogPause", fx_ignore_dialogpause_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("IntelligenceModifier", fx_intelligence_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("IntoxicationModifier", fx_intoxication_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("InvisibleDetection", fx_see_invisible_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Item:CreateDays", fx_create_item_days, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Item:CreateInSlot", fx_create_item_in_slot, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Item:CreateInventory", fx_create_inventory_item, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Item:CreateMagic", fx_create_magic_item, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Item:Equip", fx_equip_item, 0, -1, DebugEffectFormater<false>() ), //71
	EffectDesc("Item:Remove", fx_remove_item, 0, -1, DebugEffectFormater<false>() ), //70
	EffectDesc("Item:RemoveInventory", fx_remove_inventory_item, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("KillCreatureType", fx_kill_creature_type, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("LevelModifier", fx_level_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("LevelDrainModifier", fx_leveldrain_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("LoreModifier", fx_lore_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("LuckModifier", fx_luck_modifier, EFFECT_NO_LEVEL_CHECK, -1, DebugEffectFormater<false>() ),
	EffectDesc("LuckCumulative", fx_luck_cumulative, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("LuckNonCumulative", fx_luck_non_cumulative, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("MagicalColdResistanceModifier", fx_magical_cold_resistance_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("MagicalFireResistanceModifier", fx_magical_fire_resistance_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("MagicalRest", fx_magical_rest, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("MagicDamageResistanceModifier", fx_magic_damage_resistance_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("MagicResistanceModifier", fx_magic_resistance_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("MassRaiseDead", fx_mass_raise_dead, EFFECT_NO_ACTOR, -1, DebugEffectFormater<false>() ),
	EffectDesc("MaximumHPModifier", fx_maximum_hp_modifier, EFFECT_DICED, -1, DebugEffectFormater<false>() ),
	EffectDesc("Maze", fx_maze, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("MeleeDamageModifier", fx_melee_damage_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("MeleeHitModifier", fx_melee_to_hit_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("MinimumHPModifier", fx_minimum_hp_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("MiscastMagicModifier", fx_miscast_magic_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("MissileDamageModifier", fx_missile_damage_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("MissileHitModifier", fx_missile_to_hit_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("MissilesResistanceModifier", fx_missiles_resistance_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("MirrorImage", fx_mirror_image, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("MirrorImageModifier", fx_mirror_image_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ModifyGlobalVariable", fx_modify_global_variable, EFFECT_NO_ACTOR, -1, DebugEffectFormater<false>() ),
	EffectDesc("ModifyLocalVariable", fx_modify_local_variable, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("MonsterSummoning", fx_monster_summoning, EFFECT_NO_ACTOR, -1, DebugEffectFormater<false>() ),
	EffectDesc("MoraleBreakModifier", fx_morale_break_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("MoraleModifier", fx_morale_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("MovementRateModifier", fx_movement_modifier, 0, -1, DebugEffectFormater<false>() ), //fast (7e)
	EffectDesc("MovementRateModifier2", fx_movement_modifier, 0, -1, DebugEffectFormater<false>() ),//slow (b0)
	EffectDesc("MovementRateModifier3", fx_movement_modifier, 0, -1, DebugEffectFormater<false>() ),//forced (IWD - 10a)
	EffectDesc("MovementRateModifier4", fx_movement_modifier, 0, -1, DebugEffectFormater<false>() ),//slow (IWD2 - 1b9)
	EffectDesc("MoveToArea", fx_move_to_area, 0, -1, DebugEffectFormater<false>() ), //0xba
	EffectDesc("NoCircleState", fx_no_circle_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("NPCBump", fx_npc_bump, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("OffscreenAIModifier", fx_offscreenai_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("OffhandHitModifier", fx_left_to_hit_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("OpenLocksModifier", fx_open_locks_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Overlay:Entangle", fx_set_entangle_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Overlay:Grease", fx_set_grease_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Overlay:MinorGlobe", fx_set_minorglobe_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Overlay:Sanctuary", fx_set_sanctuary_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Overlay:ShieldGlobe", fx_set_shieldglobe_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Overlay:Web", fx_set_web_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("PauseTarget", fx_pause_target, 0, -1, DebugEffectFormater<false>() ), //also known as casterhold
	EffectDesc("PickPocketsModifier", fx_pick_pockets_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("PiercingResistanceModifier", fx_piercing_resistance_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("PlayMovie", fx_play_movie, EFFECT_NO_ACTOR, -1, DebugEffectFormater<false>() ),
	EffectDesc("PlaySound", fx_playsound, EFFECT_NO_ACTOR, -1, DebugEffectFormater<false>() ),
	EffectDesc("PlayVisualEffect", fx_play_visual_effect, EFFECT_REINIT_ON_LOAD, -1, DebugEffectFormater<false>() ),
	EffectDesc("PoisonResistanceModifier", fx_poison_resistance_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Polymorph", fx_polymorph, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("PortraitChange", fx_portrait_change, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("PowerWordKill", fx_power_word_kill, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("PowerWordSleep", fx_power_word_sleep, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("PowerWordStun", fx_power_word_stun, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("PriestSpellSlotsModifier", fx_bonus_priest_spells, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Proficiency", fx_proficiency, 0, -1, DebugEffectFormater<false>() ),
//	EffectDesc("Protection:Animation", fx_protection_from_animation, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Protection:Animation", fx_generic_effect, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Protection:Backstab", fx_no_backstab_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Protection:Creature", fx_generic_effect, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Protection:Opcode", fx_protection_opcode, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Protection:Opcode2", fx_protection_opcode, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Protection:Projectile",fx_protection_from_projectile, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Protection:School",fx_generic_effect, 0, -1, DebugEffectFormater<false>() ),//overlay?
	EffectDesc("Protection:SchoolDec",fx_protection_school_dec, 0, -1, DebugEffectFormater<false>() ),//overlay?
	EffectDesc("Protection:SecondaryType",fx_protection_secondary_type, 0, -1, DebugEffectFormater<false>() ),//overlay?
	EffectDesc("Protection:SecondaryTypeDec",fx_protection_secondary_type_dec, 0, -1, DebugEffectFormater<false>() ),//overlay?
	EffectDesc("Protection:Spell",fx_resist_spell, 0, -1, DebugEffectFormater<false>() ),//overlay?
	EffectDesc("Protection:SpellDec",fx_resist_spell_dec, 0, -1, DebugEffectFormater<false>() ),//overlay?
	EffectDesc("Protection:SpellLevel",fx_protection_spelllevel, 0, -1, DebugEffectFormater<false>() ),//overlay?
	EffectDesc("Protection:SpellLevelDec",fx_protection_spelllevel_dec, 0, -1, DebugEffectFormater<false>() ),//overlay?
	EffectDesc("Protection:String", fx_generic_effect, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Protection:Tracking", fx_protection_from_tracking, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Protection:Turn", fx_protection_from_turn, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Protection:Weapons", fx_immune_to_weapon, EFFECT_NO_ACTOR|EFFECT_REINIT_ON_LOAD, -1, DebugEffectFormater<false>() ),
	EffectDesc("PuppetMarker", fx_puppet_marker, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ProjectImage", fx_puppet_master, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Reveal:Area", fx_reveal_area, EFFECT_NO_ACTOR, -1, DebugEffectFormater<false>() ),
	EffectDesc("Reveal:Creatures", fx_reveal_creatures, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Reveal:Magic", fx_reveal_magic, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Reveal:Tracks", fx_reveal_tracks, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("RemoveCurse", fx_remove_curse, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("RemoveImmunity", fx_remove_immunity, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("RemoveMapNote", fx_remove_map_note, EFFECT_NO_ACTOR, -1, DebugEffectFormater<false>() ),
	EffectDesc("RemoveProjectile", fx_remove_projectile, 0, -1, DebugEffectFormater<false>() ), //removes effects from actor and area
	EffectDesc("RenableButton", fx_renable_button, 0, -1, DebugEffectFormater<false>() ), //removes disable button flag
	EffectDesc("RemoveCreature", fx_remove_creature, EFFECT_NO_ACTOR, -1, DebugEffectFormater<false>() ),
	EffectDesc("ReplaceCreature", fx_replace_creature, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ReputationModifier", fx_reputation_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("RestoreSpells", fx_restore_spell_level, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("RetreatFrom2", fx_turn_undead, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("RightHitModifier", fx_right_to_hit_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("SaveVsBreathModifier", fx_save_vs_breath_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("SaveVsDeathModifier", fx_save_vs_death_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("SaveVsPolyModifier", fx_save_vs_poly_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("SaveVsSpellsModifier", fx_save_vs_spell_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("SaveVsWandsModifier", fx_save_vs_wands_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ScreenShake", fx_screenshake, EFFECT_NO_ACTOR, -1, DebugEffectFormater<false>() ),
	EffectDesc("ScriptingState", fx_scripting_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Sequencer:Activate", fx_activate_spell_sequencer, EFFECT_PRESET_TARGET, -1, DebugEffectFormater<false>() ),
	EffectDesc("Sequencer:Create", fx_create_spell_sequencer, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Sequencer:Store", fx_store_spell_sequencer, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("SetAIScript", fx_set_ai_script, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("SetConcealment", fx_set_concealment, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("SetMapNote", fx_set_map_note, EFFECT_NO_ACTOR, -1, DebugEffectFormater<false>() ),
	EffectDesc("SetMeleeEffect", fx_generic_effect, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("SetRangedEffect", fx_generic_effect, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("SetTrap", fx_set_area_effect, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("SetTrapsModifier", fx_set_traps_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("SexModifier", fx_sex_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("SlashingResistanceModifier", fx_slashing_resistance_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Sparkle", fx_sparkle, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("SpellDurationModifier", fx_spell_duration_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Spell:Add", fx_add_innate, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Spell:Cast", fx_cast_spell, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Spell:CastPoint", fx_cast_spell_point, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Spell:Learn", fx_learn_spell, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Spell:Remove", fx_remove_spell, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("SpellFocus",fx_generic_effect , 0, -1, DebugEffectFormater<false>() ), //to implement school specific saving throw penalty to opponent
	EffectDesc("SpellResistance",fx_generic_effect , 0, -1, DebugEffectFormater<false>() ), //to implement school specific saving throw bonus
	EffectDesc("Spelltrap",fx_spelltrap , 0, -1, DebugEffectFormater<false>() ), //overlay: spmagglo
	EffectDesc("State:Berserk", fx_set_berserk_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Blind", fx_set_blind_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Blur", fx_set_blur_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Charmed", fx_set_charmed_state, EFFECT_NO_LEVEL_CHECK, -1, DebugEffectFormater<false>() ), //0x05
	EffectDesc("State:Confused", fx_set_confused_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Deafness", fx_set_deaf_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Diseased", fx_set_diseased_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Feeblemind", fx_set_feebleminded_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Hasted", fx_set_hasted_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Haste2", fx_set_hasted_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Hold", fx_hold_creature, 0, -1, DebugEffectFormater<false>() ), //175 (doesn't work in original iwd2)
	EffectDesc("State:Hold2", fx_hold_creature, 0, -1, DebugEffectFormater<false>() ),//185 (doesn't work in original iwd2)
	EffectDesc("State:Hold3", fx_hold_creature, 0, -1, DebugEffectFormater<false>() ),//109 iwd2
	EffectDesc("State:HoldNoIcon", fx_hold_creature_no_icon, 0, -1, DebugEffectFormater<false>() ), //109 (bg2) 0x6d
	EffectDesc("State:HoldNoIcon2", fx_hold_creature_no_icon, 0, -1, DebugEffectFormater<false>() ), //0xfb (iwd/iwd2)
	EffectDesc("State:HoldNoIcon3", fx_hold_creature_no_icon, 0, -1, DebugEffectFormater<false>() ), //0x1a8 (iwd2)
	EffectDesc("State:Imprisonment", fx_imprisonment, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Infravision", fx_set_infravision_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Invisible", fx_set_invisible_state, 0, -1, DebugEffectFormater<false>() ), //both invis or improved invis
	EffectDesc("State:Nondetection", fx_set_nondetection_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Panic", fx_set_panic_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Petrification", fx_set_petrified_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Poisoned", fx_set_poisoned_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Regenerating", fx_set_regenerating_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Silenced", fx_set_silenced_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Helpless", fx_set_unconscious_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Sleep", fx_set_unconscious_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Slowed", fx_set_slowed_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("State:Stun", fx_set_stun_state, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("StealthModifier", fx_stealth_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("StoneSkinModifier", fx_stoneskin_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("StoneSkin2Modifier", fx_golem_stoneskin_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("StrengthModifier", fx_strength_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("StrengthBonusModifier", fx_strength_bonus_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("SummonCreature", fx_summon_creature, EFFECT_NO_ACTOR, -1, DebugEffectFormater<false>() ),
	EffectDesc("RandomTeleport", fx_teleport_field, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("TeleportToTarget", fx_teleport_to_target, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("TimelessState", fx_timeless_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Timestop", fx_timestop, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("TitleModifier", fx_title_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ToHitModifier", fx_to_hit_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ToHitBonusModifier", fx_to_hit_bonus_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("ToHitVsCreature", fx_generic_effect, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("TrackingModifier", fx_tracking_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("TransparencyModifier", fx_transparency_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("TurnUndead", fx_turn_undead, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("UncannyDodge", fx_uncanny_dodge, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Unknown", fx_unknown, EFFECT_NO_ACTOR, -1, DebugEffectFormater<false>() ),
	EffectDesc("Unlock", fx_knock, EFFECT_NO_ACTOR, -1, DebugEffectFormater<false>() ), //open doors/containers
	EffectDesc("UnsummonCreature", fx_unsummon_creature, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("Variable:StoreLocalVariable", fx_local_variable, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("VisualAnimationEffect", fx_visual_animation_effect, 0, -1, DebugEffectFormater<false>() ), //unknown
	EffectDesc("VisualRangeModifier", fx_visual_range_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("VisualSpellHit", fx_visual_spell_hit, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("WildSurgeModifier", fx_wild_surge_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("WingBuffet", fx_wing_buffet, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("WisdomModifier", fx_wisdom_modifier, 0, -1, DebugEffectFormater<false>() ),
	EffectDesc("WizardSpellSlotsModifier", fx_bonus_wizard_spells, 0, -1, DebugEffectFormater<false>() ),
