...
static EffectDesc effectnames[] = {
	...
	EffectDesc("CastFromList", fx_select_spell, EFFECT_TAMING, -1),
	...
	EffectDesc("CastSpellOnCondition", fx_cast_spell_on_condition, EFFECT_TAMING, -1),
	...
	EffectDesc("CreateContingency", fx_create_contingency, EFFECT_TAMING, -1),
	...
	EffectDesc("Cure:Death", fx_cure_dead_state, EFFECT_TAMING, -1),
	...
	EffectDesc("DisplayEyesOverlay", fx_crash, 0, -1),
	...
	EffectDesc("FindFamiliar", fx_find_familiar, EFFECT_TAMING, -1),
	...
	EffectDesc("MakeUnselectable", fx_crash, 0, -1),
	...
	EffectDesc("Sequencer:Create", fx_create_spell_sequencer, EFFECT_TAMING, -1),
	EffectDesc("Sequencer:Store", fx_store_spell_sequencer, EFFECT_TAMING, -1),
	...
	EffectDesc("Spell:ApplySpellOnMove", fx_crash, 0, -1),
...
{
	// the bit flagged as disease is actually the active state (STATE_DEACTIVATED)
...
{
	// actual logic handled in EffectQueue
...
{
	// generic effects are handled in individually most appropriate places in the engine
	return FX_APPLIED;
}
...
int fx_remove_spell(Scriptable* /*Owner*/, Actor* target, Effect* fx)
{
	...
	switch (fx->Parameter2) {
		...
		case 1: //forget all spells of Resource
			do {
			} while (target->spellbook.HaveSpell(fx->Resource, HS_DEPLETE));
			break;
...
int fx_teleport_field(Scriptable* /*Owner*/, Actor* target, Effect* fx)
{
	...
	Point p = Point(core->Roll(1, fx->Parameter1 * 2, -(signed) (fx->Parameter1)),
			core->Roll(1, fx->Parameter1 * 2, -(signed) (fx->Parameter1))) +
		fx->Pos;
