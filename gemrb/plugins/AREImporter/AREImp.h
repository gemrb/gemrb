 ...
 *
 * $Header: /data/gemrb/cvs2svn/gemrb/gemrb/gemrb/plugins/AREImporter/AREImp.h,v 1.6 2003/11/29 07:49:24 balrog994 Exp $
 *
 */
...
private:
	...
	unsigned long ContainersOffset;
	unsigned short ContainersCount;
public:
	AREImp(void);
	~AREImp(void);
