 ...
 *
 * $Header: /data/gemrb/cvs2svn/gemrb/gemrb/gemrb/plugins/STOImporter/STOImp.cpp,v 1.2 2004/02/24 22:20:38 balrog994 Exp $
 *
 */
...
ieDword* STOImp::GetPurchasedCategories(Store* s)
{
	...
	for (int i = 0; i < s->PurchasedCategoriesCount; i++) {
		str->Read( &pc[i], 4 );
	}
