 ...
 *
 * $Header: /data/gemrb/cvs2svn/gemrb/gemrb/gemrb/plugins/NullSound/NullSnd.cpp,v 1.3 2004/08/07 13:24:38 divide Exp $
 *
 */
...
unsigned long NullSnd::Play(const char* ResRef, int XPos, int YPos, bool IsSpeech)
{
