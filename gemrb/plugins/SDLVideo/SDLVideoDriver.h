 ...
 *
 * $Header: /data/gemrb/cvs2svn/gemrb/gemrb/gemrb/plugins/SDLVideo/SDLVideoDriver.h,v 1.22 2003/12/22 21:06:15 balrog994 Exp $
 *
 */
...
public:
	...
	void BlitSpriteTinted(Sprite2D * spr, int x, int y, Color tint, Region * clip = NULL);
