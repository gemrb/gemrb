...
Door * TileMap::AddDoor(char * Name, bool DoorClosed, int ClosedIndex, unsigned short * indexes, int count, Gem_Polygon * open, Gem_Polygon * closed)
{
	...
	if(((ClosedIndex == 1) && (DoorClosed)) || ((ClosedIndex == 0) && (!DoorClosed)))
