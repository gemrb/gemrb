 ...
 *
 * $Header: /data/gemrb/cvs2svn/gemrb/gemrb/gemrb/plugins/ZLibMgr/ZLibMgr.cpp,v 1.5 2005/05/14 11:18:13 avenger_teambg Exp $
 *
 */

// ZLibMgr.cpp : Defines the entry point for the DLL application.
//
...
{
	return "ZLib Compression Manager";
}
