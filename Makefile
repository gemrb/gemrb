...
EXTRA_DIST = gemrb.kdevprj admin AUTHORS COPYING ChangeLog INSTALL README TODO gemrb.lsm 
...
#>+ 4
KDE_DIST=subdirs gemrb.kdevses configure.files Makefile.dist configure.in.in prepare-config.sh 
